      ...
      <div class="flex justify-center">
        <div class="flex space-x-7 justify-center">
          ...
          <a class="text-white hover:border-b hover:border-blue-300" href="#contact">Work with me!</a>
           ...
           <div class="flex flex-col md:hidden items-center pt-5 pb-5 border-2 w-full">
          <a class="text-white hover:border-b hover:border-blue-300 block" href="">My Projects ❤️</a>
          <a class="text-white hover:border-b hover:border-blue-300" href="">Link 2 ❤️</a>
          <a class="text-white hover:border-b hover:border-blue-300" href="">Link 3 ❤️</a>
          </div>
        </div>
      </div>
    </div>
